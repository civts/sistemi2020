...
// function that adds new file to the mainList. If already present, it is
// ignored. It automatically manages the tree
...
// function that adds new file to the incompleteList. If already present, it is
// ignored
...
void analyzerUpdateFileData(analyzer *a, uint idFile, uint totChars,
                            uint readChars, uint occurrences[INT_SIZE], uint m);

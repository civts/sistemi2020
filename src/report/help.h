...
const char *help =
    ...
    "Appositi comandi permettono di decidere, anche durante l'esecuzione,\n"
    ...
    "numeri, punteggiatura e spazi ma aggiungendo il l'opzione -e \n"
    "al comando -v è possibile visualizzare le statistiche\n"
    ...
    "questo eseguibile. Il flag --dump viene applicato a ogni analisi che\n"
    "inizia dopo che esso è stato specificato (quindi conviene inserirlo\n"
    "nel momento in cui si invoca questo eseguibile).\n"
    "\n"

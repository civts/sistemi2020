...
const char help[] =
    ...
    "        specificati\n"
    "\n"
    "Per ogni modalità di visualizzazione è possibile aggiungere il\n"
    "flag -g per indicare che anziché avere le statistiche per ogni\n"
    "carattere si volgiono raggruppate (i gruppi sono minuscole,\n"
    "maiuscole, numeri, punteggiatura, spazi e altri caratteri).\n"
